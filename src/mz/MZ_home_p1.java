...
//      MZ_logo.setBounds(33, 36, 1002, 124);
  // 로고 이미지 지정 및 불러오기
  MZ_logo.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/mzducklogo1.png")));
  // 로고 가운데 정렬
  ...
  // 텍스트 필드 옆에 배치할 버튼을 만들어줍니다.
      ...
      // 버튼에 이미지를 넣어줍니다.
      searchBtn.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/se.png")));
      // 버튼의 색상을 흰색으로 만들어줍니다.
      ...
      // K-Food를 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_K = new JButton("");
      btn_K.setBackground(Color.WHITE);
      btn_K.setIcon(new ImageIcon("../Img/k.png"));
      // 버튼 활성화 테두리 없애기
      btn_K.setBorderPainted(false);
      cenSixBtnPn.add(btn_K);
      
      // 중식을 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_C = new JButton("");
      btn_C.setBackground(Color.WHITE);
      btn_C.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/c.png")));
      // 버튼 활성화 테두리 없애기
      btn_C.setBorderPainted(false);
      cenSixBtnPn.add(btn_C);

      // 양식을 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_F = new JButton("");
      btn_F.setBackground(Color.WHITE);
      btn_F.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/f.png")));
      // 버튼 활성화 테두리 없애기
      btn_F.setBorderPainted(false);
      cenSixBtnPn.add(btn_F);
      
      // 아재푸드를 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_AZ = new JButton("");
      btn_AZ.setBackground(Color.WHITE);
      btn_AZ.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/a.png")));
      // 버튼 활성화 테두리 없애기
      btn_AZ.setBorderPainted(false);
      cenSixBtnPn.add(btn_AZ);
      
      // 일식을 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_J = new JButton("");
      btn_J.setBackground(Color.WHITE);
      btn_J.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/j.png")));
      // 버튼 활성화 테두리 없애기
      btn_J.setBorderPainted(false);
      cenSixBtnPn.add(btn_J);
      
      // 디저트를 위한 버튼을 만들고 배경색 흰색, 이미지를 넣어줍니다.
      btn_D = new JButton("");
      btn_D.setBackground(Color.WHITE);
      btn_D.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/d.png")));
      // 버튼 활성화 테두리 없애기
      btn_D.setBorderPainted(false);
      cenSixBtnPn.add(btn_D);
      
      // 6개의 버튼이 들어간 cenSixBtnPn 패널을 cenPn 패널에 넣습니다.
      ...
      btn_Home.setIcon(new ImageIcon(MZ_home_p1.class.getResource("../Img/home.png")));
